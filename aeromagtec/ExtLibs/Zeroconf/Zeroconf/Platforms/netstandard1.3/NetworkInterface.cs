            ...
            using (var client = new UdpClient())
            {
                for (var i = 0; i < retries; i++)
                {
                    try
                    {
                        ...
                        var broadcastEp = new IPEndPoint(IPAddress.Parse("127.0.0.1"), 5060);
