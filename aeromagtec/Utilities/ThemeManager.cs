...
namespace aeromagtec.Utilities
{
    ...
    public class ThemeManager
    {
        ...
        public static void doxamlgen()
        {
            ...
            temp.Add(new aeromagtec.Controls.BackstageView.BackstageView());
            temp.Add(new aeromagtec.Controls.BackstageView.BackstageViewButton());
            temp.Add(new aeromagtec.Controls.BackstageView.BackStageViewMenuPanel());
            temp.Add(new aeromagtec.Controls.ConnectionControl());
            temp.Add(new aeromagtec.Controls.ConnectionStats());
            temp.Add(new aeromagtec.Controls.Coords());
            temp.Add(new aeromagtec.Controls.FileBrowse());
            temp.Add(new aeromagtec.Controls.FlashMessage());
            temp.Add(new aeromagtec.Controls.GradientBG());
            temp.Add(new aeromagtec.Controls.HorizontalProgressBar());
            temp.Add(new aeromagtec.Controls.HorizontalProgressBar2());
            temp.Add(new aeromagtec.Controls.HSI());
            temp.Add(new aeromagtec.Controls.HUD());
            temp.Add(new aeromagtec.Controls.ImageLabel());
            temp.Add(new aeromagtec.Controls.LabelWithPseudoOpacity());
            temp.Add(new aeromagtec.Controls.LineSeparator());

            temp.Add(new aeromagtec.Controls.MyButton());
            temp.Add(new aeromagtec.Controls.myGMAP());
            temp.Add(new aeromagtec.Controls.MyLabel());
            temp.Add(new aeromagtec.Controls.MyProgressBar());
            temp.Add(new aeromagtec.Controls.MyTrackBar());
            //temp.Add(new aeromagtec.Controls.OpenGLtest());
            temp.Add(new aeromagtec.Controls.OptionForm());
            temp.Add(new aeromagtec.Controls.PictureBoxMouseOver());
            temp.Add(new aeromagtec.Controls.PictureBoxWithPseudoOpacity());
            temp.Add(new aeromagtec.Controls.ProgressReporterDialogue());
            temp.Add(new aeromagtec.Controls.ProgressStep());
            temp.Add(new aeromagtec.Controls.QuickView());
            temp.Add(new aeromagtec.Controls.RadialGradientBG());
            temp.Add(new aeromagtec.Controls.RangeControl());
            //temp.Add(new aeromagtec.Controls.ServoOptions());
            temp.Add(new aeromagtec.Controls.ValuesControl());
            temp.Add(new aeromagtec.Controls.VerticalProgressBar());
            temp.Add(new aeromagtec.Controls.VerticalProgressBar2());
...
xmlns:BackstageView=""clr-namespace:aeromagtec.Controls.BackstageView""
xmlns:Controls=""clr-namespace:aeromagtec.Controls""
xmlns:GCSViews=""clr-namespace:aeromagtec.GCSViews""
xmlns:Wizard=""clr-namespace:aeromagtec.Wizard""
xmlns:ConfigurationView=""clr-namespace:aeromagtec.GCSViews.ConfigurationView""
mc:Ignorable=""d""
> <Grid>";
        ...
        private static void doxamlctls(Control control, StreamWriter st)
        {
            foreach (Control ctl in control.Controls)
            {
                if (ctl is QuickView || ctl is ServoOptions || ctl is ModifyandSet
                    || ctl is Coords /*|| ctl is AGaugeApp.AGauge*/|| ctl is aeromagtec.Controls.HUD)
                {
